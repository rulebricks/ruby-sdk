...
require_relative "lib/rulebricks/version"
...
Gem::Specification.new do |spec|
  spec.name = "rulebricks"
  spec.authors = ["Rulebricks"]
  spec.version = Rulebricks::VERSION
  spec.summary = "Ruby client library for the Rulebricks API"
  spec.description = "The Rulebricks Ruby library provides convenient access to the Rulebricks API from Ruby."
