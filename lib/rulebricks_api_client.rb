...
module RulebricksApiClient
  ...
  api_key: api_key
      ...
      @tests = RulebricksApiClient::Tests::Client.new(request_client: @request_client)
    end
  end
  class AsyncClient
  ...
  api_key: api_key
      ...
      @tests = RulebricksApiClient::Tests::AsyncClient.new(request_client: @async_request_client)
    end
  end
end