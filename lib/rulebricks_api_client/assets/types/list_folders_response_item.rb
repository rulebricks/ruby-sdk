...
module RulebricksApiClient
  class Assets
    class ListFoldersResponseItem
      ...
      # @return [RulebricksApiClient::Assets::ListFoldersResponseItem]
      ...
      # Deserialize a JSON object to an instance of ListFoldersResponseItem
      #
      ...
      # Serialize an instance of ListFoldersResponseItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
