...
module RulebricksApiClient
  class Assets
    ...
    class ListRulesResponseItemFolder
      ...
      # @return [RulebricksApiClient::Assets::ListRulesResponseItemFolder]
      ...
      # Deserialize a JSON object to an instance of ListRulesResponseItemFolder
      #
      ...
      # Serialize an instance of ListRulesResponseItemFolder to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
