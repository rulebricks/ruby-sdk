...
module RulebricksApiClient
  class Assets
    class ListFlowsResponseItem
      ...
      attr_reader :slug
      # @return [String] The date this flow was last updated.
      ...
      # @param updated_at [String] The date this flow was last updated.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [RulebricksApiClient::Assets::ListFlowsResponseItem]
      ...
      # Deserialize a JSON object to an instance of ListFlowsResponseItem
      #
      ...
      # Serialize an instance of ListFlowsResponseItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
