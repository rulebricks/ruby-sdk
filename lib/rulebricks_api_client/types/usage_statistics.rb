...
module RulebricksApiClient
  ...
  # @return [Object] 
    ...
    def initialize(plan: OMIT, monthly_period_start: OMIT, monthly_period_end: OMIT, monthly_executions_usage: OMIT, monthly_executions_limit: OMIT, monthly_executions_remaining: OMIT, additional_properties: nil)
      ...
      @_field_set = { "plan": plan, "monthly_period_start": monthly_period_start, "monthly_period_end": monthly_period_end, "monthly_executions_usage": monthly_executions_usage, "monthly_executions_limit": monthly_executions_limit, "monthly_executions_remaining": monthly_executions_remaining }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of UsageStatistics
    #
    ...
    def self.from_json(json_object:)
      ...
      monthly_period_start = parsed_json["monthly_period_start"]
      monthly_period_end = parsed_json["monthly_period_end"]
      monthly_executions_usage = parsed_json["monthly_executions_usage"]
      monthly_executions_limit = parsed_json["monthly_executions_limit"]
      monthly_executions_remaining = parsed_json["monthly_executions_remaining"]
      new(
        plan: plan,
...
# Serialize an instance of UsageStatistics to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
