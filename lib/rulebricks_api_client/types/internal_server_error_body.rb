...
module RulebricksApiClient
  class InternalServerErrorBody
    # @return [String] Error message describing the internal server error.
    attr_reader :error
    ...
    # @param error [String] Error message describing the internal server error.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [RulebricksApiClient::InternalServerErrorBody]
