...
# Error message or flag indicating if evaluation error occurred
  class TestTestStateEvaluationError


# Deserialize a JSON object to an instance of TestTestStateEvaluationError
    #
    # @param json_object [String] 
    # @return [RulebricksApiClient::TestTestStateEvaluationError]
