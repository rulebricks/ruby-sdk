...
module RulebricksApiClient
  class TestTestStateConditionsItemValue
  # @return [Boolean] 
    attr_reader :result
  # @return [String] 
    attr_reader :err
  ...
  # @return [Object] 
    ...
    # @return [RulebricksApiClient::TestTestStateConditionsItemValue]
...
# Deserialize a JSON object to an instance of TestTestStateConditionsItemValue
    #
...
# Serialize an instance of TestTestStateConditionsItemValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
