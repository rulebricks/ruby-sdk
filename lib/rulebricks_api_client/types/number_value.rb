...
module RulebricksApiClient
  ...
  # @return [Object] 
    ...
    # @param value [Float] The numeric value
    ...
    # @return [RulebricksApiClient::NumberValue]
...
# Deserialize a JSON object to an instance of NumberValue
    #
...
# Serialize an instance of NumberValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
