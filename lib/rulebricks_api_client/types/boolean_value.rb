...
module RulebricksApiClient
  ...
  # @return [Object] 
    ...
    # @return [RulebricksApiClient::BooleanValue]
    def initialize(value: OMIT, id: OMIT, name: OMIT, usages: OMIT, access_groups: OMIT, additional_properties: nil)
      ...
      @_field_set = { "value": value, "id": id, "name": name, "usages": usages, "accessGroups": access_groups }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of BooleanValue
    #
...
# Serialize an instance of BooleanValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.value&.is_a?(Boolean) != false || raise("Passed value for field obj.value is not the expected type, validation failed.")
