...
module RulebricksApiClient
  class Values
    class DeleteDynamicValueResponse
      ...
      # Deserialize a JSON object to an instance of DeleteDynamicValueResponse
      #
      ...
      # Serialize an instance of DeleteDynamicValueResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
