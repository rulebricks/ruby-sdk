...
module RulebricksApiClient
  module Values
    class UpdateValuesRequestValuesValue


# Deserialize a JSON object to an instance of UpdateValuesRequestValuesValue
      #
      # @param json_object [String] 
      # @return [RulebricksApiClient::Values::UpdateValuesRequestValuesValue]
