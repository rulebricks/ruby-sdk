...
module RulebricksApiClient
  class Rules
    class ListResponseItemRequestSchemaItem
      # @return [String] The key for the request field.
      attr_reader :key
      # @return [Boolean] Whether the field is visible in the rule editor.
      attr_reader :show
      # @return [String] The name of the request field.
      attr_reader :name
      # @return [String] The description of the request field.
      attr_reader :description
      # @return [String] The data type of the request field.
      attr_reader :type
      # @return [String] The default value of the request field.
      attr_reader :default_value
      # @return [String] The computed default value of the request field.
      attr_reader :default_computed_value
      # @return [String] The transformation applied to the request field.
      ...
      # @param key [String] The key for the request field.
      # @param show [Boolean] Whether the field is visible in the rule editor.
      # @param name [String] The name of the request field.
      # @param description [String] The description of the request field.
      # @param type [String] The data type of the request field.
      # @param default_value [String] The default value of the request field.
      # @param default_computed_value [String] The computed default value of the request field.
      # @param transform [String] The transformation applied to the request field.
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [RulebricksApiClient::Rules::ListResponseItemRequestSchemaItem]
      ...
      # Deserialize a JSON object to an instance of ListResponseItemRequestSchemaItem
      #
      ...
      # Serialize an instance of ListResponseItemRequestSchemaItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
