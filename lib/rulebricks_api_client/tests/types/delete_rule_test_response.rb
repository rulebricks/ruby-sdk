...
module RulebricksApiClient
  class Tests
    class DeleteRuleTestResponse
      ...
      # Deserialize a JSON object to an instance of DeleteRuleTestResponse
      #
      ...
      # Serialize an instance of DeleteRuleTestResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
