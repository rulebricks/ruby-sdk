...
module RulebricksApiClient
  class Tests
    class DeleteFlowTestResponse
      ...
      # Deserialize a JSON object to an instance of DeleteFlowTestResponse
      #
      ...
      # Serialize an instance of DeleteFlowTestResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
