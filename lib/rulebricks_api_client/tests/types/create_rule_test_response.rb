...
module RulebricksApiClient
  class Tests
    class CreateRuleTestResponse
      ...
      # Deserialize a JSON object to an instance of CreateRuleTestResponse
      #
      ...
      # Serialize an instance of CreateRuleTestResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
