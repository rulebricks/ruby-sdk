...
module RulebricksApiClient
  class Tests
    class CreateFlowTestResponse
      ...
      # Deserialize a JSON object to an instance of CreateFlowTestResponse
      #
      ...
      # Serialize an instance of CreateFlowTestResponse to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
