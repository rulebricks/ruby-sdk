...
module RulebricksApiClient
  class Tests
    class ListRuleTestsResponseItem
      ...
      # @return [RulebricksApiClient::Tests::ListRuleTestsResponseItem]
      ...
      # Deserialize a JSON object to an instance of ListRuleTestsResponseItem
      #
      ...
      # Serialize an instance of ListRuleTestsResponseItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
