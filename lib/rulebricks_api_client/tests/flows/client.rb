...
#  )
#  api.tests.flows.list(slug: "slug")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/admin/flows/#{slug}/tests"
end
...
#    api_key: "YOUR_API_KEY"
#  )
#  api.tests.flows.create(slug: "slug", request: { name: "Test 3", request: { "param1": "value1" }, response: { "status": "success" }, critical: true })
...
#    api_key: "YOUR_API_KEY"
#  )
#  api.tests.flows.delete(slug: "slug", test_id: "testId")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/admin/flows/#{slug}/tests/#{test_id}"
end
        RulebricksApiClient::Test.from_json(json_object: response.body)
      end
    end
