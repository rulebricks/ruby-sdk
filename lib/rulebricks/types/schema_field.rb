...
module Rulebricks
  module Types
    class SchemaField < Internal::Types::Model
      ...
      field :default_value, -> { Rulebricks::Types::SchemaFieldDefaultValue }, optional: true, nullable: false
      field :default_computed_value, -> { String }, optional: true, nullable: false
