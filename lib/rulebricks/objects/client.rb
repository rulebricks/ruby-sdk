...
module Rulebricks
  module Objects
    class Client
      ...
      # Lists the workspace's objects (JSON Schemas). Results are scoped to the API key holder's user groups, matching
      # the visibility model of values, rules, and flows: group-restricted keys only see objects whose user_groups
      # overlap theirs.
      #
      ...
      # Creates or updates an object by ID or name and syncs enum values it generates. Objects help workspace admins
      # programmatically determine multiple collections of values based on Rulebricks' contracts with external systems
      # from a single JSON Schema source.
      #
      # @param request_options [Hash]
      # @param params [Rulebricks::Objects::Types::UpsertObjectRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def upsert(request_options: {}, **params)
        ...
        request = Rulebricks::Internal::JSON::Request.new(
          ...
          method: "PUT",
          path: "objects",
          body: Rulebricks::Objects::Types::UpsertObjectRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # Deletes the object. Its generated values always lose their management lock; by default they are also archived
      # (published rules keep resolving them by id). Pass values=detach to keep them active as ordinary, hand-editable
      # values instead. Requires the manage objects entitlement.
      #
      # @param request_options [Hash]
      # @param params [Hash]
      # @option request_options [String] :base_url
