      ...
      class Client
        ...
        def list(request_options: {}, **params)
          ...
          request = Rulebricks::Internal::JSON::Request.new(
            ...
            method: "GET",
            path: "admin/rules/#{URI.encode_uri_component(params[:slug].to_s)}/tests",
        ...
        # Adds a new test to the rule. `contains` (Contains Data, the default) finds the expected fragment anywhere in
        ...
        def delete(request_options: {}, **params)
          ...
          request = Rulebricks::Internal::JSON::Request.new(
            base_url: request_options[:base_url],
            method: "DELETE",
            path: "admin/rules/#{URI.encode_uri_component(params[:slug].to_s)}/tests/#{URI.encode_uri_component(params[:test_id].to_s)}",
            request_options: request_options
          )
          begin
            response = @client.send(request)
