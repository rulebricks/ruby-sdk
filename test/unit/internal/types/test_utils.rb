...
describe Rulebricks::Internal::Types::Utils do
  Utils = Rulebricks::Internal::Types::Utils

  module TestUtils
    class M < Rulebricks::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Rulebricks::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Rulebricks::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Rulebricks::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Rulebricks::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Rulebricks::Internal::Types::Array[String]
      ModelArray = -> { Rulebricks::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Rulebricks::Internal::Types::Array[TestUtils::U] }
