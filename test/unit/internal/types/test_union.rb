...
describe Rulebricks::Internal::Types::Union do
  class Rectangle < Rulebricks::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Rulebricks::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Rulebricks::Internal::Types::Model
