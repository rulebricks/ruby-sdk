...
describe Rulebricks::Internal::Types::Model do
  ...
  class ExampleModel < Rulebricks::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Rulebricks::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Rulebricks::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Rulebricks::Internal::Types::Model
